...
\begin{abstracts}[Abstract only]
  ...
  \altaffiltext{3}{Universidad de los Andes, Cra 1 Nº 18A- 12 Bogot\'{a}, (Colombia),
  ...
  \abstract{
    [1] Recently Ibata et. Al (2013) proposed the presence of a
    vast thin plane of corrotating dwarf galaxies orbiting the
    Andromeda Galaxy. 
    
    [2] Dynamical simulations of the behavior of this
    system using observational data have been made in order to propose
    the time evolution of this structure. 

    [3] In these simulations the tangential velocity of the satellite
    galaxies had to be supposed, due to unavailable observational
    data. 

    [4] We propose using large 
    scale Non Linear Programming (NLP) optimization algorithms to
    determine the values of these tangential velocities. 

    [5] This
    numerical optimization is implemented by minimizing the difference
    ...
    [6]The results of this study indicate the
    feasibility of the initial conditions and the trajectories
    proposed and shed light on the possible formation processes and
    stability of this structure of galaxies in our local cluster.}  
\end{abstracts}

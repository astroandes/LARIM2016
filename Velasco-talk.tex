...
\begin{abstracts}[Abstract only]
  ...
  respect to the Milky Way is around $v_{tan}
  \sim 30 km s^{-1}$ while other groups claim values of $v_{tan}
  100 km s^{-1}$.
  This leads to the question of what is the most likely kinematic
  configuration for the Local Group. 
  In this work we use cosmological simulation in order to define those
  most common kinematic configurations.
  ...
  mass. 
  In turn, assuming the most accepted constraints for the LG total mass and the
  cosmological parameters we find that the observed LG has atypical kinematics
  once it is considered in a broad cosmological context. 
  }
